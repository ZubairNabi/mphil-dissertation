...
graph~\cite{Murray:2011:CUE,Murray:2011:ADE}. The latter is stored in a task
...
Tasks are scheduled on workers from the worker table once their dependencies
switch from a state of future reference to concrete reference. The task table is
