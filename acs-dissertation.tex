...
2. Master works as a centralized scheduler: Mission Control.

3. Workers have flight controllers which deal with local state.

4. Works at the application layer.

5. Model: Transfer foo to bar.
